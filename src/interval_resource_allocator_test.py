...
class IntervalResourceAllocatorTest(unittest.TestCase):
    def test_init(self):
        manager = IntervalResourceAllocator(reference="Test", interval_duration=datetime.timedelta(seconds=60))
    ...
    def test_allocate_resource(self):
        ...
        manager = IntervalResourceAllocator(reference="Test", interval_duration=datetime.timedelta(seconds=60), resources=resources)
    ...
    def test_get_nearest_intervals_to_window_start(self):
        ...
        resources = [Resource(id="id1")]
        manager = IntervalResourceAllocator(reference="Test", interval_duration=datetime.timedelta(hours=1), resources=resources)
